...
namespace log4net.Tests.Util
{
	...
	public class SystemInfoTest
	{
...
#if !NETSTANDARD1_3
		[TestMethod][NUnit.Framework.Platform(Include="Win")]
		...
		[TestMethod, Microsoft.VisualStudio.TestTools.UnitTesting.ExpectedException(typeof(TypeLoadException))]
        ...
        {
            Assert.IsTrue(SystemInfo.EqualsIgnoringCase(null, null));
        }

        [TestMethod]
        public void EqualsIgnoringCase_LeftNull_false()
        {
            Assert.IsFalse(SystemInfo.EqualsIgnoringCase(null, "foo"));
        }

        [TestMethod]
        public void EqualsIgnoringCase_RightNull_false()
        {
            Assert.IsFalse(SystemInfo.EqualsIgnoringCase("foo", null));
        }

        [TestMethod]
        public void EqualsIgnoringCase_SameStringsSameCase_true()
        {
            Assert.IsTrue(SystemInfo.EqualsIgnoringCase("foo", "foo"));
        }
        ...
        {
            Assert.IsFalse(SystemInfo.EqualsIgnoringCase("foo", "foobar"));
        }
	}
}
